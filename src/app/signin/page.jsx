...
const page = () => {
    return (
        <div className=' h-screen w-screen bg-gradient-to-r from-slate-600 to-neutral-100 flex flex-col gap-5 justify-center'>
            <h1 className=' text-xl flex justify-start mx-[41%] font-bold text-slate-800 sm:justify-start md:text-4xl'>Sign in</h1>
            <form action="" className=' flex flex-col gap-5 justify-center items-center '>
                ...
                <button className=' border rounded-3xl px-28 py-3 bg-red-300'>Login</button>
            </form>
